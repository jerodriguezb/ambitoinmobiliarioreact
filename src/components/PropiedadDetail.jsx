          ...
          >
            <div className="carousel-inner">
              <div className="carousel-item active">
                <img
                  src="https://lh3.googleusercontent.com/yXATP_OwCP6o3DoEKQAdkx16Fzlt2XQLixk9PnegcUUgvEMx2yoxfX7ZxkE-Vs_3VDLIF3cZ5Gvxa-qa3d4q0NS3DaCkS_--OenklRHVsMqTImSudejcVZR73uYfLypWZWGxPTDtJA=w2400"
        ...
        <div className="col-8">
          ...
          <div className="col">
            <div className="row">
              ...
              <ul className="fa-ul">
                <li>
                  <i id="check1" className="fa fa-check-circle mr-2"></i>Baños:{" "}
                  {data.Baño}
                </li>
              </ul>
            </div>
            ...
            <div className="row mt-5">
              {data.Cocina ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Cocina
                  </li>
                </ul>
              ) : (
                ""
              ...
              {data.BañoServicio ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Baño
                    Servicio
                  </li>
                </ul>
              ) : (
              ...
              {data.Living ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Living
                  </li>
                </ul>
              ) : (
                ""
              ...
              {data.Balcon ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Balcon
                  </li>
                </ul>
              ) : (
                ""
              ...
              {data.Jardin ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Jardin
                  </li>
                </ul>
              ) : (
                ""
              ...
              {data.SUM ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>SUM
                  </li>
                </ul>
              ) : (
                ""
              ...
              {data.Patio ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Patio
                  </li>
                </ul>
              ) : (
                ""
              ...
              {data.Pileta ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Pileta
                  </li>
                </ul>
              ) : (
                ""
              ...
              {data.Asador ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Asador
                  </li>
                </ul>
              ) : (
                ""
              ...
              {data.Suite ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Suite
                  </li>
                </ul>
              ) : (
                ""
              ...
              {data.SalaEstarPlayroom ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Sala
                    Estar Playroom
                  </li>
                </ul>
              ) : (
              ...
              {data.Gas ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Gas
                  </li>
                </ul>
              ) : (
                ""
              ...
              {data.Agua ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Agua
                  </li>
                </ul>
              ) : (
                ""
              ...
              {data.Cable ? (
                <ul className="fa-ul">
                  <li>
                    <i id="check" className="fa fa-check-circle mr-2"></i>Cable
                  </li>
                </ul>
              ) : (
                ""
