...
const Propiedades = () => {
  ...
  //console.log(propiedades.data.propiedades[0]._id);

  //console.log(propiedades.data.propiedades);

  return (
    <div>
      {/* <h3>{propiedades.data.propiedades[0].Titulo}</h3> */}
      {/* <h3>{propiedades.data.propiedades[0]}</h3> */}
    </div>
    ...
    //         <b>
    //           <h3 className="mt-5">Conoce a las</h3>
    //         </b>
    //         <b>
    ...
    //                       </i>
    //                       <h3 className="mt-5">
    //                         {propiedad.CodigoPropiedad} - Cod. Int.{" "}
    //                         {propiedad.id}
    //                       </h3>
    //                     </div>
    //                   </div>
